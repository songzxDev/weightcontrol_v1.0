		...
		function _7(_b) {
			_b.addClass("menu").find(">div").each(function() {
						...
						if (_c.hasClass("menu-sep")) {
							...
							var _d = $.extend({}, $.parser.parseOptions(this, ["name", "iconCls", "href"]), {
										disabled : (_c.attr("disabled") ? true : undefined)
									});
	...
	$.fn.menu = function(_3a, _3b) {
		...
		return this.each(function() {
					...
					if (_3c) {
						...
						_3c = $.data(this, "menu", {
									options : $.extend({}, $.fn.menu.defaults, $.fn.menu.parseOptions(this), _3a)
								});
						_1(this);
					}
					$(this).css({
