...
(function($) {
	...
	function _7(_8) {
		...
		if (_f > _10) {
			...
			_e.css({
						...
						marginRight : _d.outerWidth() + _b._outerWidth(),
						left : 0,
	...
	function _25(_26) {
		...
		cc.children("div.tabs-panels").children("div").each(function(i) {
					var _28 = $.extend({}, $.parser.parseOptions(this), {
	...
	function _32(_33, pp, _34) {
		...
		_36.tab.unbind(".tabs").bind("click.tabs", {
					p : pp
				}, function(e) {
	...
	function _39(_40, _41) {
		...
		pp.panel($.extend({}, _41.options, {
					iconCls : (_41.options.icon ? _41.options.icon : undefined)
				}));
	...
	$.fn.tabs.parseOptions = function(_79) {
		return $.extend({}, $.parser.parseOptions(_79, ["width", "height", "tools", {
									fit : "boolean",
									border : "boolean",
									plain : "boolean"
								}]));
