...
(function($) {
	...
	function _18(_19) {
		...
		_1b.find("div.tree-node").draggable({
					disabled : false,
					revert : true,
					cursor : "pointer",
					proxy : function(_1c) {
	...
	function _14(_c0, _c1) {
		var _c2 = $.extend({}, $.data(_c1, "tree-node"), {
					target : _c1,
					checked : $(_c1).find(".tree-checkbox").hasClass("tree-checkbox1")
				});
		if (!_45(_c0, _c1)) {
