...
(function($) {
	...
	function init(target) {
		...
		/**
		 * wrap a menu and set it's status to hidden the menu not include sub menus
		 */
	...
	$.fn.menu.methods = {
		...
		/**
		 * set the menu item text param: { target: DOM object, indicate the menu item text: string, the new text }
		 */
		...
		/**
		 * set the menu icon class param: { target: DOM object, indicate the menu item iconCls: the menu item icon class }
		 */
		...
		/**
		 * get the menu item data that contains the following property: { target: DOM object, the menu item id: the menu id text: the menu item text iconCls: the icon class href: a remote address to redirect to onclick: a function to be called when the item is clicked }
		 */
		...
		/**
		 * append menu item, the param contains following properties: parent,id,text,iconCls,href,onclick when parent property is assigned, append menu item to it
		 */
